...
public class OVRDisplay
{
	...
	/// </summary>
    public EyeRenderDesc GetEyeRenderDesc(VR.XRNode eye)
	{
	...
	{
		ConfigureEyeDesc(VR.XRNode.LeftEye);
        ConfigureEyeDesc(VR.XRNode.RightEye);
	}

    private void ConfigureEyeDesc(VR.XRNode eye)
	{
		if (!VR.XRDevice.isPresent)
			return;
